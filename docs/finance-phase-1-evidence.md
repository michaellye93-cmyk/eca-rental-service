...
- Read-only live August ledger control: 232 rows; cash **RM90,714.49**; service claims **RM4,397.30**; settled revenue **RM95,111.79**. Date range August 1–31. No missing driver joins in that aggregate inspection.
...
- `Sales_Report_August_2026.xlsx`: 89 detailed rows; gross revenue **RM21,950**; commission **RM6,391**. After applying the supplied Finance master, six rows for **VKF7180** remain unmatched and visible for Admin review.
