...
- The real user workbook's Office Rental row validates with amount [removed], start/end 2026-08-01 and null Expense Date. Nine rows have approved categories and total RM [removed], independently recomputed from Excel cell values. Row 13, Company Loan / Financing, remains blocked for approved-category classification; it is not silently treated as an operating cost.
