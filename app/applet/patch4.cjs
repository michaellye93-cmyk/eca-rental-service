...
// The original lines around grid:
...
// We need to fix the extra </div> and put bg-amber-50 INSIDE the grid (before the grid closing </div>)
// Let me just replace the entire block from <div className="grid ... to 
// bank statement audit buttons.
